...
#define LOG_DETAIL(logger, ...) \
    logger.log(Logger::kDetail, METHOD_NAME, " | ", __VA_ARGS__)
#define LOG_DEBUG(logger, ...) \
    logger.log(Logger::kDebug, METHOD_NAME, " | ", __VA_ARGS__)
#define LOG_INFO(logger, ...) \
    logger.log(Logger::kInfo, \
               BOLD_GREEN, \
               METHOD_NAME, \
               " | ", \
               RESET_COLOR, \
...
#define LOG_WARNING(logger, ...) \
    logger.log(Logger::kWarning, \
               BOLD_RED, \
               METHOD_NAME, \
               " | ", \
               RESET_COLOR, \
               __VA_ARGS__)
#define LOG_STATS(logger, ...) \
    logger.log(Logger::kStats, \
               BOLD_GREEN, \
               METHOD_NAME, \
               " | ", \
               RESET_COLOR, \
